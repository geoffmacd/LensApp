...
- (void)applicationWillResignActive:(UIApplication *)application
{
    ...
    [[[LensNetworkController sharedNetwork] queue] setSuspended:YES];
}
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    ...
    [[[LensNetworkController sharedNetwork] queue] setSuspended:NO];
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"LensApp" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"LensApp.sqlite"];
    
    NSError *error = nil;
    _persistentStoreCoordinator = [[NSPersistentStoreCoordinator alloc] initWithManagedObjectModel:[self managedObjectModel]];
    
#if TARGET_IPHONE_SIMULATOR
    NSString * persistType = NSInMemoryStoreType;
#else
    NSString * persistType = NSSQLiteStoreType;
#endif
    if (![_persistentStoreCoordinator addPersistentStoreWithType:persistType configuration:nil URL:storeURL options:nil error:&error]) {
        /*
         Replace this implementation with code to handle the error appropriately.
